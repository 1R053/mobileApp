...
* By email: intern@clouttechnologies.com`;
    ...
    function goToLogin() {
        SecureStore.setItemAsync(constants.localStorage_termsAccepted, 'true').then(
            () => {
    ...
    return screenNumber === 0 ?
        <View style={styles.container}>
            ...
            <Text style={styles.description}>The first decentralized social network app ever built completely on BitClout public API.</Text>

            <Text style={[styles.description, { marginTop: 40 }]}>
                <Text>
                    Our goal is to provide the best social network experience where we
                </Text>
                <Text style={styles.bold}> DO NOT:</Text>
            </Text>
            <Text style={[styles.description, styles.listMargin]}>
                <Text style={styles.bold}>1. </Text>
                <Text>Show Ads to our users.</Text>
            </Text>
            <Text style={[styles.description, styles.listMargin]}>
                <Text style={styles.bold}>2. </Text>
                <Text>Collect user's usage data and commercialize it.</Text>
            </Text>
            <Text style={[styles.description, styles.listMargin]}>
                <Text style={styles.bold}>3. </Text>
                <Text>Use the user as a product.</Text>
            </Text>
        ...
        <View style={[styles.container, { paddingLeft: 10, paddingRight: 10 }]}>
            <View style={[styles.titleContainer, { alignItems: 'center', marginTop: 20 }]}>
                <MaterialCommunityIcons name="shield-alert" size={60} color="black" />
                <Text style={[styles.title, { fontSize: 25, marginTop: 20 }]}>Terms and Conditions</Text>
            </View>
            ...
            <View style={styles.checkBoxContainer}>
                <TouchableOpacity activeOpacity={1} onPress={() => setTermsAndConditionsAccepted(!termsAndConditionsAccepted)}>
                    {
            ...
            <TouchableOpacity
                ...
                style={[styles.mainButton, { marginBottom: '10%', backgroundColor: termsAndConditionsAccepted ? 'black' : '#999999' }]}
                activeOpacity={1}
                onPress={goToLogin}>
                <Text style={styles.mainButtonText}>Continue</Text>
            </TouchableOpacity>
